...
# Page config
st.set_page_config(
    page_title="Distributed Video Engine Research Prototype",
    page_icon="⚡",
    layout="wide"
)

# Title and Description
st.title("Distributed Video Engine Research Prototype")
st.markdown("""
This interface exposes the research prototype for FFmpeg-based parallel video processing.
It can be used to compare serial execution, equal-duration partitioning, and adaptive planning paths.
""")
...
use_smart_mode = st.sidebar.checkbox("Adaptive Planning", value=False, help="Enable heuristic adaptive partitioning and scheduler-driven configuration selection.")

if use_smart_mode:
    st.sidebar.info("The engine will select a research-oriented adaptive configuration.")
